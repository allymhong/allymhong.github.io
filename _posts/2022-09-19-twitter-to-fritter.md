...
* requires a IPIN phone number verification + legally checks your DM's when provoked. Why? Well, after a [17-year-old girl kidnapped and murdered an 8-year-old in Incheon, South Korea](https://ko.wikipedia.org/wiki/%EC%9D%B8%EC%B2%9C_%EC%B4%88%EB%93%B1%ED%95%99%EC%83%9D_%EC%82%B4%ED%95%B4_%EC%82%AC%EA%B1%B4){:target="_blank"} inspired by connections with Korean Hannibal Twitter (a community inspired by the show on Hannibal Lecter, the infamous cannibalistic serial killer), Korean Twitter policies enacted verification requirements. Korean Twitter policies also allow for searching of DMs, as apparently the 17-yo murderer would receive DM's through Twitter to kill certain people.

But he took on the role that even with new policy in place to better the app, it wasn't necessarily Twitter's fault. He said,
...
_**Synthesis.**_
Ah, the final synthesis. Reflecting throughout my VSD analysis on Twitter, I learned a lot about the depths and avenues the app creates: it feels like a whole virtual world with subcultures, diffusion, and divided autonomies within itself. I was especially surprised to learn that Gideon used to have an account that grew to 60k - and even more concerned that he himself was threatened. I had mention in my VSD analysis of non-targeted use under the [Stakeholders](#stakeholders) section that users could get doxxed - I was concerned that Gideon was also a victim. Even when he grew his account base, maintaining relationships throughout such heightened times with other users caused him to erase his account out of concern. For Fritter (once again, a Fret-Free Twitter), I'd want to minimize any likelihood of compromising user security. Doing so requires end-to-end encryption to protect sensitive personal data, especially through DM's; with all other social media, though, general recommendations to  lead users to protect their data throughout the Internet in a pop-up or tab within Fritter, to demonstrate practical methods of protection, may be useful. I want users to feel safe and protected not only on Fritter, but throughout their time on- and offline.

With Gideon's reflections on how social media revealed and highlighted human behavior, I applied his analysis to the inherent cultural and societal differences between South Korea and the U.S. - of course the two Twitter bases are going to contrast heavily. But it was interesting to see how K-Hip-Hop Twitter's takes on BLM, despite having some overlay between African American and Korean culture, still found avenues of controversy, hate, and divergence. Design features that could help Fritter bridge gaps between understanding and make room for diverse perspective is for more mixing of timelines between countries - either with translated Tweets, or taking advantage of Tweets already in said countries' languages. For example, U.S.-based users that Tweet in Korean can show up in Korean Twitter's feeds; and vice versa. I can't think of any design-based workarounds for differences in each nation's policy - I wouldn't want to get in trouble with the South Korean government for the allowance of posts by North Korean refugees, but maybe I could make these policies more transparent on Fritter? Gideon became more aware about this when he familiarized himself with U.S.-based Twitter and saw the Tweets for himself, but it's entirely possible that Korean Twitter users - and users in other countries with unique limitations - are unaware. 

Finally, Gideon's story about the 17-yo girl who utilized Twitter DM's left me in fear and shock. I didn't even want him to initially send me the Wiki page on the matter, actually, because I didn't want to know... I was afraid. I quickly agreed to why Korean Twitter solicited searching through DM's and now requires iPIN verification (which is similar to my looking to incorporate 2-factor-authentication to prevent hackers and bots from Fritter non-targeted use) - but reflecting back in a lessened emotional state, I ponder if the allowance to search through DM's overly compromises user privacy. If I want users to feel safe on the app, I wouldn't want users to think that the app was out against them. I may have to research on more cases like this - and in agreement with Gideon's quote on revealing human behavior through social media, I'm not sure if policy will change much.

But I loop back and forth and contradict myself - if Korean Hannibal Twitter didn't take - and violent trends and shows glorifying serial killers weren't available, would that 17-yo girl still have done the same? It's a new question, of whether the show was created first, or if the 17-yo girl's murderous intents were always there. I guess that's a deeper question about the human psyche. But in that case, I believe that censoring content and moderating speech on Fritter may cut out some levels of free expression that Twitter allows for. I'm brainstorming a way I could keep the beneficial ends of free expression while cutting out the bad - and with my inherent values as a Christian, I'm thinking of disallowing all nude content on Fritter, as well as graphic violence. I'd rather have people feel that they're missing out on pornographic or violent content, rather than find exploitative content on the platform.

All in all, interviewing Gideon made me ask more questions towards myself and humanity in general. It almost made me feel a bit helpless in trying to scope the perfect design features and policies to manage Fritter as a safe space, but then looping back to realize that "You are what you eat" in the long-run encouraged me to search for the fine lines - a place where users like Gideon and Chiara who enjoy the free expression of Twitter and community bases, but don't want to be doxxed or be flooded with triggering content - want to keep staying active. Fritter will be that place.